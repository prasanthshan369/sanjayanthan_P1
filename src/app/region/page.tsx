...
const handleDelete = (id: number,region:string) => {
 ...
 const handleSelectRegion = (selectedOption: SelectOption) => {
  const { value, label } = selectedOption;
...
const handleNewEntry=()=>{
  ...
  return (
    <div className="flex ">
      ...
      <Header/>
      <label className="  text-2xl font-semibold text-gray-700 dark:text-gray-200">Region Access Configuration</label>
        {" "}
